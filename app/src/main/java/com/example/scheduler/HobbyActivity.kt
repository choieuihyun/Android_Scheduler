...
class HobbyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val hobbyGif = findViewById<ImageView>(R.id.hobby_gif)

        Glide.with(this).load(R.raw.hobby).into(hobbyGif)
    ...
    override fun onResume() {
        super.onResume()
        hobby_button.setOnClickListener {
            ...
            var listener = DialogInterface.OnClickListener { p0, p1 ->
                ...
                intent.putExtra("hobbyTime", data)
